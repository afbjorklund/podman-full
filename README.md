...
```shell
mkdir -p /tmp/lima
cp policy.json registries.conf podman-full-5.8.0-linux-amd64.tar.gz /tmp/lima
...
lima sudo tar Cxzf /usr/local /tmp/lima/podman-full-5.8.0-linux-amd64.tar.gz
